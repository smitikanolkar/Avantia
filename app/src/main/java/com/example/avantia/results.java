...
//            ImageView menubaru = findViewById(R.id.menubarresult);
...
//            });
            ...
            ValueEventListener listener = new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(results.this, "Can't connect", Toast.LENGTH_SHORT).show();
                }
            };
        ...
        public class ListAdapter extends BaseAdapter {
            ...
            public View getView(int i, View view, ViewGroup viewGroup) {
                ...
                if (data[i].getSelectedAnswer()==data[i].getCorrectAnswer()) {
                    ...
                    result.setTextColor(ContextCompat.getColor(results.this, R.color.green_dark));
                    result.setText("Correct Answer");
                } else {
                    result.setBackgroundResource(R.drawable.red_background);
                    result.setTextColor(ContextCompat.getColor(results.this, R.color.red_dark));
